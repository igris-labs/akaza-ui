  ...
  >
    ...
    <template #footer="{ close }">
      ...
      >
        ...
        <button
          class="rounded-lg bg-neutral-900 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-neutral-700 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-100"
          @click="() => close()"
        >
          Save changes
        </button>
