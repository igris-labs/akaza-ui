...
<template>
  ...
  >
    <Input
      ...
      class="h-9 w-full max-w-sm rounded-lg border border-neutral-200 bg-white px-3 text-sm outline-none focus:border-neutral-900 data-[akaza-invalid]:border-red-500 dark:border-neutral-800 dark:bg-neutral-950 dark:focus:border-neutral-100"
    />
  </Field>
</template>
