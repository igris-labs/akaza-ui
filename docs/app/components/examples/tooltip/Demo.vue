      ...
      <template #trigger>
        ...
        >
          ...
          >
            ...
            <path
              d="M8 1.5v2M8 12.5v2M1.5 8h2M12.5 8h2M3.4 3.4l1.4 1.4M11.2 11.2l1.4 1.4M11.2 4.8l1.4-1.4M3.4 12.6l1.4-1.4"
    ...
    <Tooltip direction="top" :delay-duration="200" :ui="{ content: 'tooltip-content' }">
      <template #trigger>
        ...
        >
          ...
          >
            <path
              d="M8 1.5A5 5 0 003 6.5v2.5L2 11h12l-1-2V6.5A5 5 0 008 1.5z"
      ...
      <template #content>Notifications</template>
    </Tooltip>
      ...
      <template #trigger>
        ...
        >
          ...
          >
            ...
            <path d="M6 6.5a2 2 0 113 1.732c-.5.29-1 .768-1 1.268M8 11v.5" stroke-linecap="round" />
          </svg>
        </button>
      </template>
      <template #content>Help center</template>
    </Tooltip>
  </div>
</template>
