...
import type { MonthRangePickerProps } from ".";
...
const props = withDefaults(defineProps<MonthRangePickerProps>(), {
  calendarLabel: "Month range picker",
});
...
const periodProps = computed(() => {
  const { calendarLabel, maximumMonths, isMonthDisabled, isMonthUnavailable, ...rest } = props;
  return {
    ...rest,
    pickerLabel: calendarLabel,
    maximumPeriods: maximumMonths,
