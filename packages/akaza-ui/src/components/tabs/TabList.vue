...
import { inject, onMounted, nextTick, ref, useTemplateRef, watch } from 'vue'
...
<template>
  <component ref="rootRef" :is="as" role="tablist" :aria-orientation="orientation" class="akaza-tab-list">
    <slot />
    <span class="akaza-tab-indicator" :style="indicatorStyle" aria-hidden="true" />
  </component>
</template>
